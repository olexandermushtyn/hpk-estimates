...
const LessonSimpleForm = (props) => {
  ...
  return (
    <Form
      ...
      autoComplete="off"
    >
      <Title level={4}>{props?.showTitle && 'Lesson'}</Title>
      <Form.Item
        label="Name"
        name="name"
      ...
      >
        <Input
          ...
          autoFocus
          placeholder={t('Please enter your lesson name')}
        />
      </Form.Item>
...
export default LessonSimpleForm
